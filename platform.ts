...
export class Platform{
    ...
    public setRealese(releaseYear: number){
        this.releaseYear = releaseYear
    }
    public setCompany(company: string){
        this.company = company
    }
    public setBits(nBits: number){
        this.nBits = nBits
    }
    public setGen(generation: number){
        this.generation = generation
    }
    public setHD(hasHD: boolean){
        this.hasHD = hasHD
    }
    public setHdSize(hdSize: number){
        this.hdSize = hdSize
    }
    public setConex(hasInternetConex: boolean){
        this.hasInternetConex = hasInternetConex
    }
    public setStoage(storageDevice: storageDevice){
        this.storageDevice = storageDevice
    }
    ...
    public toStringPlatform(): string{
        return('' + this.name + '\n' + this.releaseYear + '\n' + 
                this.company + '\n' + this.nBits + '\n' +
                this.generation + '\n' + this.hasHD + '\n' + this.hdSize + '\n' + 
